...
def build_turn_messages(
    *,
    ...
    system_parts = [part for part in (persona, self_state, f"回复风格：{response_style}" if response_style else "") if part]
    return [
...
async def run_brain_turn(
    ...
    *,
    ...
    return await complete_with_provider(provider_config, messages)
