(() => {
  ...
  function collectAppRefs(runtimeDocument = document) {
    return {
      ...
      petMenuGameEl: byId(runtimeDocument, "pet-menu-game"),
      petMenuGameLabelEl: byId(runtimeDocument, "pet-menu-game-label"),
      petMenuGameDetailEl: byId(runtimeDocument, "pet-menu-game-detail"),
