...
class ChatModesUiTests(unittest.TestCase):
    ...
    def test_settings_replaces_old_topic_history_controls_with_neo_aspect_controls(self) -> None:
        ...
        self.assertNotIn('id="memory-review-queue"', html)
        self.assertIn('id="memory-saved-list"', html)
        self.assertIn('id="memory-pending-list"', html)
        self.assertIn('id="memory-open-loop-list"', html)
        self.assertIn('id="memory-follow-up-enabled"', html)
        self.assertIn('/api/memory', js)
        ...
        self.assertIn('id="ops-authorization-mode"', html)
    ...
    def test_settings_excludes_removed_platform_controls(self) -> None:
        ...
        self.assertIn('opsAuthorizationMode', settings_source)
        self.assertNotIn('opsRequireActReview', settings_source)
